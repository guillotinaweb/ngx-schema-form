...
*/
  ...
  it(`# 1. Test boolean as boolean`, waitForAsync(() => {
    ...
    fixture.whenStable().then(() => {
      ...
      expect(
        app.schema.properties.demo.properties.typeTest.fieldsets[0].description
      ).toEqual("# 1. Test boolean");
      ...
      // initial state
      let _test_boolean_check = fixture.debugElement.query(
        By.css("#demo\\.typeTest\\.checkbool")
      );
      expect(_test_boolean_check).toBeTruthy();

      let _test_boolean_visible = fixture.debugElement.query(
        By.css("#demo\\.typeTest\\.testbool")
      );
      expect(_test_boolean_visible).toBeNull();

      let _test_boolean_visible_negative = fixture.debugElement.query(
        By.css("#demo\\.typeTest\\.testboolnegative")
      );
      ...
      _test_boolean_visible_negative = fixture.debugElement.query(
        By.css("#demo\\.typeTest\\.testboolnegative")
      );
  ...
  it(`# 1. Test boolean as string`, waitForAsync(() => {
    ...
    fixture.whenStable().then(() => {
      ...
      // initial state
      let _test_boolean_check_true = fixture.debugElement.query(
        By.css("#demo\\.typeTest\\.checkboolstring\\.true")
      );
      expect(_test_boolean_check_true).toBeTruthy();
      let _test_boolean_check_false = fixture.debugElement.query(
        By.css("#demo\\.typeTest\\.checkboolstring\\.false")
      );
      expect(_test_boolean_check_false).toBeTruthy();

      let _test_boolean_visible = fixture.debugElement.query(
        By.css("#demo\\.typeTest\\.testboolstring")
      );
      expect(_test_boolean_visible).toBeNull();
      ...
      _test_boolean_check_false.nativeElement.dispatchEvent(
        new Event("change")
      );
      fixture.detectChanges();
  ...
  it(`# 2. Test number`, waitForAsync(() => {
    ...
    fixture.whenStable().then(() => {
      ...
      // expect selected sample schema to be loaded
      expect(
        app.schema.properties.demo.properties.typeTest.fieldsets[1].description
      ).toEqual("# 2. Test number");
      ...
      // initial state
      let _test_number_input = fixture.debugElement.query(
        By.css("#demo\\.typeTest\\.checknum")
      );
      expect(_test_number_input).toBeTruthy();

      let _test_number_visible = fixture.debugElement.query(
        By.css("#demo\\.typeTest\\.testnum")
      );
  ...
  it(`# 2. Test number as string`, waitForAsync(() => {
    ...
    fixture.whenStable().then(() => {
      ...
      // initial state
      let _test_number_select = fixture.debugElement.query(
        By.css("#demo\\.typeTest\\.checknumstring")
      );
      expect(_test_number_select).toBeTruthy();

      let _test_number_visible = fixture.debugElement.query(
        By.css("#demo\\.typeTest\\.testnumstring")
      );
      expect(_test_number_visible).toBeNull();

      // positive state
      _test_number_select.nativeElement.value =
        _test_number_select.nativeElement.options[1].value; // set to '1'
      ...
      // negative state
      _test_number_select.nativeElement.value =
        _test_number_select.nativeElement.options[2].value; // set to '2'
      _test_number_select.nativeElement.dispatchEvent(new Event("change"));
      fixture.detectChanges();
  ...
  it(`# 3. Test string`, waitForAsync(() => {
    ...
    fixture.whenStable().then(() => {
      ...
      // expect selected sample schema to be loaded
      expect(
        app.schema.properties.demo.properties.typeTest.fieldsets[2].description
      ).toEqual("# 3. Test string");
      ...
      // initial state
      let _test_string_input = fixture.debugElement.query(
        By.css("#demo\\.typeTest\\.checkstring")
      );
      expect(_test_string_input).toBeTruthy();

      let _test_number_visible = fixture.debugElement.query(
        By.css("#demo\\.typeTest\\.teststring")
      );
      expect(_test_number_visible).toBeNull();
...
*/
  ...
  it(`# 4. Test 'VisibleIf' with default 'one-of' with multiple values`, waitForAsync(() => {
    ...
    fixture.whenStable().then(() => {
      ...
      // initial state
      let _test_boolean_check_pass = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding1a\\.status1a\\.Pass")
      );
      expect(_test_boolean_check_pass).toBeTruthy();
      let _test_boolean_check_warn = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding1a\\.status1a\\.Warn")
      );
      expect(_test_boolean_check_warn).toBeTruthy();
      let _test_boolean_check_fail = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding1a\\.status1a\\.Fail")
      );
      expect(_test_boolean_check_fail).toBeTruthy();

      let _test_boolean_visible = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding1a\\.visibleComponent1a")
      );
      expect(_test_boolean_visible).toBeNull();
  ...
  it(`# 5. Test 'VisibleIf' with 'oneOf' condition`, waitForAsync(() => {
    // Visible component shows up if status value is 'Warn' or 'Fail'
    ...
    fixture.whenStable().then(() => {
      ...
      // initial state
      let _test_boolean_check_pass = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding1b\\.status1b\\.Pass")
      );
      expect(_test_boolean_check_pass).toBeTruthy();
      let _test_boolean_check_warn = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding1b\\.status1b\\.Warn")
      );
      expect(_test_boolean_check_warn).toBeTruthy();
      let _test_boolean_check_fail = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding1b\\.status1b\\.Fail")
      );
      expect(_test_boolean_check_fail).toBeTruthy();
  ...
  it(`# 6. Test Boolean 'VisibleIf' with 'allOf' condition (check 'Warn' and 'Fail')`, waitForAsync(() => {
    ...
    fixture.whenStable().then(() => {
      ...
      // initial state
      let _test_checkbox_pass = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding2a\\.status2a")
      );
      expect(_test_checkbox_pass).toBeTruthy();
      let _test_checkbox_warn = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding2a\\.status2b")
      );
      expect(_test_checkbox_warn).toBeTruthy();
      let _test_checkbox_fail = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding2a\\.status2c")
      );
      expect(_test_checkbox_fail).toBeTruthy();

      let _test_boolean_visible = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding2a\\.visibleComponent2a")
      );
      expect(_test_boolean_visible).toBeNull();

      const visibleComponent =
        "#demo\\.visibleIfBinding2a\\.visibleComponent2a";
      const checkboxes = [
        _test_checkbox_pass,
        _test_checkbox_warn,
        _test_checkbox_fail,
      ...
      for (const combination of combinations) {
        for (let i = 0; i < combination.values.length; i++) {
          ...
          const _test_boolean_visible_el = fixture.debugElement.query(
            By.css(visibleComponent)
          );
          const errorOut = `Expected visibility ${
            combination.visible
          } | emits: ${combination.emit || false} | checked: pass:${
            combination.values[0]
          }/native:${checkboxes[0].nativeElement.checked}, warn:${
            combination.values[1]
          }/native:${checkboxes[1].nativeElement.checked}, fail:${
            combination.values[2]
          }/native:${checkboxes[2].nativeElement.checked}`;
          if (
            _test_checkbox_warn.nativeElement.checked &&
            _test_checkbox_fail.nativeElement.checked
          ) {
  ...
  it(`# 7. Test String 'VisibleIf' with 'allOf' condition (select 'Warn' and 'Fail')`, waitForAsync(() => {
    // Visible component shows up if status 'Warn' and 'Fail' are checked
    ...
    fixture.whenStable().then(() => {
      ...
      // initial state
      let _test_select_pass = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding2b\\.status2a")
      );
      expect(_test_select_pass).toBeTruthy();
      let _test_select_warn = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding2b\\.status2b")
      );
      expect(_test_select_warn).toBeTruthy();
      let _test_select_fail = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding2b\\.status2c")
      );
      expect(_test_select_fail).toBeTruthy();

      let _test_select_visible = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding2b\\.visibleComponent2b")
      );
      expect(_test_select_visible).toBeNull();

      const visibleComponent =
        "#demo\\.visibleIfBinding2b\\.visibleComponent2b";
      const dropdowns = [
        _test_select_pass,
        _test_select_warn,
        _test_select_fail,
      ...
      for (const combination of combinations) {
        for (let i = 0; i < combination.values.length; i++) {
          ...
          const errorOut = `Expected visibility ${
            ...
            combination.values[0]
          }/native:${dropdowns[0].nativeElement.value}, warn:${
            combination.values[1]
          }/native:${dropdowns[1].nativeElement.value}, fail:${
            combination.values[2]
          }/native:${dropdowns[2].nativeElement.value}`;
          if (
            _test_select_warn.nativeElement.value === "Warn" &&
            _test_select_fail.nativeElement.value === "Fail"
          ) {
  ...
  it(`# 8. Test oneOf - Set age to 15, set last name to 'aaa'`, waitForAsync(() => {
    ...
    fixture.whenStable().then(() => {
      ...
      // initial state
      let _test_input_age = fixture.debugElement.query(
        By.css("#demo\\.updateVisibiltyTest\\.age")
      );
      expect(_test_input_age).toBeTruthy();
      let _test_select_lastname = fixture.debugElement.query(
        By.css("#demo\\.updateVisibiltyTest\\.lastName")
      );
      expect(_test_select_lastname).toBeTruthy();

      let _test_visible_component = fixture.debugElement.query(
        By.css("#demo\\.updateVisibiltyTest\\.firstName")
      );
      expect(_test_visible_component).toBeNull();

      let visibleComponent = "#demo\\.updateVisibiltyTest\\.firstName";
      let elements = [_test_input_age, _test_select_lastname];
      ...
      for (const combination of combinations) {
        for (let i = 0; i < combination.values.length; i++) {
          ...
          const errorOut = `Expected visibility ${
            combination.visible
          } | emits: ${combination.emit || false} | checked: age:${
            combination.values[0]
          }/native:${elements[0].nativeElement.value}, firstname:${
            combination.values[1]
          }/native:${elements[1].nativeElement.value}`;
          if (
            _test_input_age.nativeElement.value === 15 &&
            _test_select_lastname.nativeElement.value === "aaa"
          ) {
            expect(_test_select_visible_el).toBeTruthy(errorOut);
          } else {
            expect(_test_select_visible_el).toBeNull(errorOut);
...
describe("JsonSchemaExampleComponent - visibleIf - condition-types (chained conditions)", () => {
  ...
  it(`# 1. Test 'VisibleIf' with 'all-of' of 'one-of's. One of 1a and 1b must be Pass and one of 1c and 1d must be Pass`, waitForAsync(() => {
    // Visible component shows up if status value is 'Warn' or 'Fail'
    ...
    fixture.whenStable().then(() => {
      ...
      // initial state
      let _test_status1a = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding1\\.status1a")
      ).nativeElement;
      expect(_test_status1a.value).toBe("");
      let _test_status1b = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding1\\.status1b")
      ).nativeElement;
      expect(_test_status1b.value).toBe("");
      let _test_status1c = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding1\\.status1c")
      ).nativeElement;
      expect(_test_status1c.value).toBe("");
      let _test_status1d = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding1\\.status1d")
      ).nativeElement;
      expect(_test_status1d.value).toBe("");

      let _test_visbility = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding1\\.visibleComponent1a")
      );
      ...
      fixture.detectChanges();
      _test_visbility = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding1\\.visibleComponent1a")
      );
      expect(_test_visbility).toBeNull();
  ...
  it(`# 2. Test 'VisibleIf' with 'one-of' of 'all-of's. All of 2a, 2b and 2c must be Fail or 2d must be Fail`, waitForAsync(() => {
    // Visible component shows up if status value is 'Warn' or 'Fail'
    ...
    fixture.whenStable().then(() => {
      ...
      // initial state
      let _test_status2a = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding2\\.status2a")
      ).nativeElement;
      expect(_test_status2a.value).toBe("");
      let _test_status2b = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding2\\.status2b")
      ).nativeElement;
      expect(_test_status2b.value).toBe("");
      let _test_status2c = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding2\\.status2c")
      ).nativeElement;
      expect(_test_status2c.value).toBe("");
      let _test_status2d = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding2\\.status2d")
      ).nativeElement;
      expect(_test_status2d.value).toBe("");

      let _test_visbility = fixture.debugElement.query(
        By.css("#demo\\.visibleIfBinding2\\.visibleComponent2a")
      );
      expect(_test_visbility).toBeNull();
...
describe("JsonSchemaExampleComponent - visibleIf - array items have visibleIf fields", () => {
  ...
  it(`# 1. Test 'VisibleIf' within an element of an array`, waitForAsync(() => {
    // Visible component shows up if status value is 'Warn' or 'Fail'
    ...
    fixture.whenStable().then(() => {
      ...
      // Add an element
      const _add_button = fixture.debugElement.query(
        By.css(".array-add-button")
      ).nativeElement;
      _add_button.click();
      fixture.detectChanges();
      // initial state
      const _select: HTMLSelectElement = fixture.debugElement.query(
        By.css("#arrayObject\\.0\\.showHiddenField")
      ).nativeElement;
      let _input = fixture.debugElement.query(
        By.css("#arrayObject\\.0\\.visibleTest")
      );
