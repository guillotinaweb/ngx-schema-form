...
describe("ObjectProperty", () => {
	...
	let A_FORM_PROPERTY_FACTORY = new FormPropertyFactory(A_SCHEMA_VALIDATOR_FACTORY);
	...
	beforeEach(() => {
		objProperty = new ObjectProperty(A_FORM_PROPERTY_FACTORY, A_SCHEMA_VALIDATOR_FACTORY, THE_OBJECT_SCHEMA, null);
	});
	...
	it("should reset all its properties on reset", () => {
		let propFactory = new FormPropertyFactory(A_SCHEMA_VALIDATOR_FACTORY);
		let objProp = new ObjectProperty(propFactory, A_SCHEMA_VALIDATOR_FACTORY, THE_OBJECT_SCHEMA, null);
