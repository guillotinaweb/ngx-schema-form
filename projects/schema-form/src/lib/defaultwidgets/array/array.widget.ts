...
@Component({
  ...
  template: `<div class="widget form-group">
    ...
    } @for (itemProperty of iterableProperties; track itemProperty) {
    <div>
      <sf-form-element [formProperty]="itemProperty"></sf-form-element>
      @if (!(schema.hasOwnProperty('minItems') &&
      schema.hasOwnProperty('maxItems') && schema.minItems === schema.maxItems))
      {
      <button
...
export class ArrayWidget extends ArrayLayoutWidget {
  ...
  iterableProperties = this.formProperty?.properties
    ? new Map(Object.entries(this.formProperty.properties))
    : [];
